...
| | |
|---|---|
| **Milestone** | **M1–M4 complete** · M5 started (T-024, T-025, T-026, T-027 done) · M6 (T-028, T-029, T-030 done) · M7 started (T-032, T-033, T-036 done) · **M8 complete (T-037…T-040 done)** · **M9 resolved (T-043 done; T-041/T-042/T-044 deferred — nothing left undeferred)** · **M10 complete (T-045…T-050 done)** |
| **Tickets** | 41 done · 11 remaining · 9 deferred · **61 defined, 52 in scope** |
| **Tests** | 2157 passing (1922 in `make test`; 219 in `make test-integration`; 12 in `make test-e2e`; 4 in `make bench`) |
