...
**Last updated:** during T-052 (chaos suite), after the settlement fix it uncovered.
...
| | |
|---|---|
| **Milestone** | **M1–M4 complete** · M5 started (T-024, T-025, T-026, T-027 done) · M6 (T-028, T-029, T-030 done) · M7 started (T-032, T-033, T-036 done) · **M8 complete (T-037…T-040 done)** · **M9 resolved (T-043 done; T-041/T-042/T-044 deferred — nothing left undeferred)** · **M10 complete (T-045…T-050 done)** · **M11 under way (T-051, T-052 done; T-053 measured)** |
| **Tickets** | 43 done · 9 remaining · 9 deferred · **61 defined, 52 in scope** |
| **Tests** | 2269 passing (2011 in `make test`; 235 in `make test-integration`; 13 in `make test-e2e`; 10 in `make bench`; **10 in `make chaos`**) |
...
| **CI** | green — six jobs: lint/types/tests + **NFR-1 benchmark**, integration against real Postgres, **the end-to-end slice**, **chaos (nightly cron only)**, core purity, compose health |
...
|---|---|---|
| T-054…T-059 | Security scanning, evidence pack, deployment, submission, drills | M7/M11 |
