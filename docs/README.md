...
| [`threat-model.md`](threat-model.md) | 23 STRIDE threats, each with a mitigation, a status, and the test id covering it. Four came out of implementation rather than brainstorming. |
