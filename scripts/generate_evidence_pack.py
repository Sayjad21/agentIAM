...
def render() -> str:
    ...
    return (
        ...
        # No generation date here, deliberately. The `--check` gate in CI asserts this
        # file is a *pure function of its committed sources*, and a wall-clock stamp made
        # it a function of the day it ran instead: the pack was generated on 2026-08-19,
        # so every push from 2026-08-20 onward regenerated a one-character-different file
        # and failed the job. Nothing about the sources had changed. Git already records
        # when the pack was committed, and records it more reliably than a string inside
        # the artefact does.
        "(T-055) &mdash; generated from sources committed in this repository. "
