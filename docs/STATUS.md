...
| **Tests** | 2055 passing (1861 in `make test`; 178 in `make test-integration`; 12 in `make test-e2e`; 4 in `make bench`) |
...
|---|---|---|
| T-048, T-049, T-050 | Audit explorer + custody view, Grafana dashboards, escalation queue UI | M10 |
